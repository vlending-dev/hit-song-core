...
from hitsongcore.file import Audio
...
class ModelLoader:
    def __init__(self, device: str = None, model_path: str = 'model.pt', num_classes: int = 0):
    ...
    @torch.no_grad()
    def calc_prediction(self, audio_file_path: str):
